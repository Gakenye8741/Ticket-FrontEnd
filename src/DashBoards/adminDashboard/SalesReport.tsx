...
const SalesReport: React.FC = () => {
  ...
  if (loading || loadingEvents) return <div className="p-6 text-gray-700 dark:text-gray-100">Loading report...</div>;
        ...
        >
          ...
          <div className="overflow-x-auto">
            <table className="table-auto w-full text-sm">
              ...
              <tbody>
                {ev.ticketBreakdown.map((t: TicketBreakdown, tIndex: number) => (
                  <tr key={tIndex} className="border-t border-gray-200 dark:border-gray-700">
