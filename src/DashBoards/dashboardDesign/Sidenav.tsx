...
export const SideNav = ({ onNavItemClick }: { onNavItemClick?: () => void }) => {
  ...
  const menuItems = [
    ...
    { to: "Payments", label: "Billing", icon: <CreditCard size={20} />, color: "text-emerald-500" },
      ...
      <div className="w-full p-8 mb-2">
        <div className="flex items-center gap-4 group cursor-pointer w-full">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-xl font-black tracking-tighter text-base-content leading-none uppercase italic truncate">
